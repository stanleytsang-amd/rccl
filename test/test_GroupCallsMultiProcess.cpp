...
namespace CorrectnessTests
{
    TEST_P(GroupCallsMultiProcessCorrectnessTest, Correctness)
    {
        ...
        ncclFuncs.push_back(ncclCollAllToAll);
        ncclFuncs.push_back(ncclCollBroadcast);
        ncclFuncs.push_back(ncclCollGather);
        ncclFuncs.push_back(ncclCollScatter);
    ...
    INSTANTIATE_TEST_CASE_P(GroupCallsMultiProcessCorrectnessSweep,
